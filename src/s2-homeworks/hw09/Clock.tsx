...
function Clock() {
    ...
    const stringDate = new Intl.DateTimeFormat("en-GB", {
        ...
        month: "2-digit",
        year: "numeric",
    }).format(date).replace(/\//g, '.') || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем

    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    let dayFormatter = new Intl.DateTimeFormat("en-GB", {
        weekday: "long"
    });
    const stringDay = dayFormatter.format(date) || <br/> // пишут студенты

    let monthFormatter = new Intl.DateTimeFormat("en-GB", {
        month: "long"
    });
